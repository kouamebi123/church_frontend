          ...
          overflowX: 'auto'
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 4, alignItems: 'center' }}>
                <Box>
                  ...
                  >
                    {i18nService.t('dashboard.networks.management')}
                  </Typography>
                  <Box sx={{ 
                    width: 80, 
                    height: 4, 
                    ...
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell sx={{ fontWeight: 700, color: 'white' }}>Responsable(s)</TableCell>
                                <TableCell sx={{ fontWeight: 700, color: 'white' }}>Église</TableCell>
                                <TableCell align="right" sx={{ fontWeight: 700, color: 'white' }}>{i18nService.t('dashboard.networks.table.actions')}</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                                                            ...
                                                            <TableBody>
                                                                {Array.isArray(networkGrs[network.id || network._id]) && networkGrs[network.id || network._id].map((gr) => (
                                                                        <React.Fragment key={gr.id || gr._id}>
                                                                            <TableRow 
                                                                              hover 
                                                                              onClick={e => { e.stopPropagation(); handleGrClick(gr.id || gr._id); }} 
                                                                              sx={{ cursor: 'pointer' }}
                                                                            >
                                                                                        ...
                                                                                        <Box component="ol" sx={{ 
                                                                                          ...
                                                                                          {(groupDetails[gr.id || gr._id]?.members || []).map(member => {
                                                                                                  ...
                                                                                                  return (
                                                                                                      ...
                                                                                                      >
                                                                                                          <Typography component="span" sx={{ mr: 1.5, fontSize: '1.2rem' }}>
                                                                                                            👤
                                                                                                          </Typography>
