            ...
            {loading ? (
                ...
                <TableContainer data-aos="fade-up" component={Paper}>
                    <Table>
                        <TableHead>
                            <TableRow>
                                <TableCell>{i18nService.t('dashboard.groups.table.name')}</TableCell>
                                <TableCell>{i18nService.t('dashboard.groups.table.responsible1')}</TableCell>
                                <TableCell>{i18nService.t('dashboard.groups.table.responsible2')}</TableCell>
                                <TableCell>{i18nService.t('dashboard.groups.table.members')}</TableCell>
                                <TableCell align="right">{i18nService.t('dashboard.groups.table.actions')}</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
