    ...
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        ...
        <Tooltip title="Actualiser les données">
          <IconButton onClick={loadActivities} disabled={loading} color="primary">
            <RefreshIcon />
          </IconButton>
        </Tooltip>
      </Box>
      ...
      <Paper>
        <TableContainer>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell>{i18nService.t('historys.user')}</TableCell>
                <TableCell>{i18nService.t('historys.action')}</TableCell>
                <TableCell>{i18nService.t('historys.entity')}</TableCell>
                <TableCell>Nom de l'entité</TableCell>
                <TableCell>{i18nService.t('historys.timestamp')}</TableCell>
                <TableCell>{i18nService.t('historys.details')}</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
