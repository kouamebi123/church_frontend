            ...
            {testimonies.map((testimony) => (
              <Grid item xs={12} md={6} lg={4} key={testimony.id} sx={{ width: '100%'}}>
                <Card sx={{ 
                  ...
                  border: testimony.isRead ? '1px solid var(--testimony-border-read)' : '1px solid var(--testimony-border-unread)',
                  boxShadow: testimony.isRead ? 'none' : '0 2px 8px var(--testimony-shadow-unread)'
                }}>
