    ...
    <Box sx={{ 
      ...
      {conversations.length === 0 ? (
        <Box sx={{ 
          ...
          <MessageIcon sx={{ fontSize: 48, mb: 2, opacity: 0.3 }} />
            ...
            <React.Fragment key={conversation.id}>
              <ListItem 
                ...
                sx={{
                  ...
                  borderRadius: 2,
                  mb: 1,
                  backgroundColor: (conversation.lastMessage.is_read || conversation.lastMessage.message_type === 'sent') ? 'rgba(255, 255, 255, 0.84)' : 'primary.special',
                  border: (conversation.lastMessage.is_read || conversation.lastMessage.message_type === 'sent') ? 'none' : '1px solid',
                  borderColor: (conversation.lastMessage.is_read || conversation.lastMessage.message_type === 'sent') ? 'transparent' : 'primary.special',
                  cursor: 'pointer',
                  '&:hover': {
                    backgroundColor: (conversation.lastMessage.is_read || conversation.lastMessage.message_type === 'sent') ? 'background.default' : 'primary.specialHover',
      ...
      <Box sx={{ 
        ...
        {loading ? (
          ...
          <Box sx={{ textAlign: 'center', py: 4, color: 'text.secondary' }}>
            <Typography variant="body2">Aucun message dans cette conversation</Typography>
          </Box>
        ) : (
              ...
              >
                <Box
                  sx={{
                    ...
                    p: 1.5,
                    borderRadius: 2,
                    backgroundColor: msg.is_from_current_user ? 'primary.main' : 'background.default',
      ...
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', gap: 1, alignItems: 'flex-end' }}>
          <TextField
            ...
            sx={{
              '& .MuiOutlinedInput-root': {
                backgroundColor: isSendingMessage ? 'background.paper' : 'background.default',
                borderRadius: 2,
          ...
          <IconButton
            ...
            sx={{
              ...
              '&:hover': {
                ...
                transform: isSendingMessage ? 'scale(0.95)' : 'scale(1.05)'
              },
              '&:disabled': {
