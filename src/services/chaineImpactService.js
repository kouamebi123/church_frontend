...
export const chaineImpactService = {
  ...
  getChaineImpact: async (churchId) => {
    try {
      ...
      // logger.error('Erreur lors de la récupération de la chaîne d\'impact:', error);
      throw error;
    }
  },
  ...
  getChaineImpactByUser: async (userId) => {
    try {
      ...
      // logger.error('Erreur lors de la récupération de la chaîne d\'impact de l\'utilisateur:', error);
      throw error;
    }
  },
  ...
  updateChaineImpact: async (churchId) => {
    try {
      ...
      // logger.error('Erreur lors de la mise à jour de la chaîne d\'impact:', error);
      throw error;
    }
  },
  ...
  deleteChaineImpact: async (churchId) => {
    try {
      ...
      // logger.error('Erreur lors de la suppression de la chaîne d\'impact:', error);
      throw error;
    }
  }
};
