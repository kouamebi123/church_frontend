  ...
  constructor() {
    this.themes = {
      light: {
        ...
        variables: {
          // Couleurs principales - Palette ACER ZNO
          '--primary-color': '#662d91', // Violet principal ACER
          '--primary-light': '#9e005d',
          '--primary-dark': '#1b1464', // Bleu marine ACER
          '--secondary-color': '#9e005d', // Magenta ACER
          '--secondary-light': '#A78BFA',
          '--secondary-dark': '#2a3184', // Bleu foncé ACER
          ...
          '--chart-colors': ['#1b1464', '#2a3184', '#B19CD9', '#6A1B9A', '#2D004D'],
          
          // Couleurs d'accessibilité
          '--focus-ring': 'rgba(102, 45, 145, 0.25)',
          '--selection-background': 'rgba(102, 45, 145, 0.2)',
          ...
          '--gradient-primary': 'linear-gradient(90deg, #1b1464 0%, rgb(102, 13, 185) 50%, #1b1464 100%)',
          '--gradient-header': 'linear-gradient(135deg, #1b1464 0%, rgb(103, 14, 187) 50%, #1b1464 100%)',
          '--gradient-button': 'linear-gradient(135deg, #1b1464 0%, rgb(93, 10, 170) 50%, rgb(65, 0, 111) 100%)',
          '--gradient-button-hover': 'linear-gradient(135deg, rgb(95, 8, 176) 0%, rgb(97, 4, 163) 50%, rgb(84, 7, 156) 100%)',
          '--gradient-success': 'linear-gradient(135deg, #1b1464 0%, #2a3184 100%)',
          '--gradient-success-hover': 'linear-gradient(135deg, rgb(104,9,192) 0%, #1b1464 100%)',
          '--overlay-light': 'rgba(76, 0, 130, 0.34)',
          '--overlay-medium': 'rgba(104, 15, 187, 0.34)',
          '--overlay-heavy': 'rgba(76, 0, 130, 0.37)',
          '--overlay-bottom': 'rgba(102, 45, 145, 0.3)',
          '--overlay-middle': 'rgba(112, 19, 199, 0.2)',
          '--modal-bg': 'rgba(255, 255, 255, 0.97)',
          '--modal-shadow': 'rgba(102, 45, 145, 0.2)',
          '--modal-border-light': 'rgba(255, 255, 255, 0.3)',
          '--drop-shadow': 'rgba(0,0,0,0.3)',
          '--upload-bg': 'rgba(102, 45, 145, 0.05)',
          '--upload-hover-bg': 'rgba(102, 45, 145, 0.1)',
          '--upload-shadow': 'rgba(102, 45, 145, 0.2)',
          '--button-shadow': 'rgba(102, 45, 145, 0.3)',
          '--button-hover-shadow': 'rgba(102, 45, 145, 0.4)',
          '--button-disabled': 'rgba(102, 45, 145, 0.3)',
          ...
          '--card-shadow': 'rgba(102, 45, 145, 0.3)',
          '--card-hover-shadow': 'rgba(102, 45, 145, 0.4)',
          '--info-bg': 'rgba(76, 0, 130, 0.04)',
          '--info-border': 'rgba(76, 0, 130, 0.06)',
          '--info-shadow': 'rgba(76, 0, 130, 0.04)',
          '--chip-bg': 'rgba(102, 45, 145, 0.1)',
          '--chip-border': 'rgba(102, 45, 145, 0.3)',
          ...
          '--success-button-shadow': 'rgba(102, 45, 145, 0.28)',
          '--success-hover-shadow': 'rgba(102, 45, 145, 0.34)',
      ...
      dark: {
        ...
        variables: {
          // Couleurs principales - Palette ACER ZNO
          '--primary-color': '#9e005d', // Magenta ACER pour le thème sombre
          '--primary-light': '#B19CD9',
          '--primary-dark': '#662d91', // Violet principal ACER
          '--secondary-color': '#2a3184', // Bleu foncé ACER
          '--secondary-light': '#D4C4E8',
          '--secondary-dark': '#1b1464', // Bleu marine ACER
          ...
          // Couleurs de graphique
          '--chart-colors': ['#2a3184', '#B19CD9', '#D4C4E8', '#1b1464', '#2D004D'],
          
          // Couleurs d'accessibilité
          '--focus-ring': 'rgba(158, 0, 93, 0.25)',
          '--selection-background': 'rgba(158, 0, 93, 0.2)',
          ...
          '--gradient-primary': 'linear-gradient(90deg, #2a3184 0%, rgb(177, 156, 217) 50%, #2a3184 100%)',
          '--gradient-header': 'linear-gradient(135deg, #2a3184 0%, rgb(177, 156, 217) 50%, #2a3184 100%)',
          '--gradient-button': 'linear-gradient(135deg, #2a3184 0%, rgb(138, 43, 226) 50%, rgb(106, 27, 154) 100%)',
          '--gradient-button-hover': 'linear-gradient(135deg, rgb(138, 43, 226) 0%, rgb(106, 27, 154) 50%, rgb(75, 0, 130) 100%)',
          '--gradient-success': 'linear-gradient(135deg, #2a3184 0%, #B19CD9 100%)',
          '--gradient-success-hover': 'linear-gradient(135deg, rgb(138, 43, 226) 0%, #2a3184 100%)',
          '--overlay-light': 'rgba(158, 0, 93, 0.34)',
          '--overlay-medium': 'rgba(177, 156, 217, 0.34)',
          '--overlay-heavy': 'rgba(158, 0, 93, 0.37)',
          '--overlay-bottom': 'rgba(158, 0, 93, 0.3)',
          '--overlay-middle': 'rgba(177, 156, 217, 0.2)',
          '--modal-bg': 'rgba(45, 45, 45, 0.97)',
          '--modal-shadow': 'rgba(158, 0, 93, 0.2)',
          '--modal-border-light': 'rgba(255, 255, 255, 0.1)',
          '--drop-shadow': 'rgba(0, 0, 0, 0.6)',
          '--upload-bg': 'rgba(158, 0, 93, 0.05)',
          '--upload-hover-bg': 'rgba(158, 0, 93, 0.1)',
          '--upload-shadow': 'rgba(158, 0, 93, 0.2)',
          '--button-shadow': 'rgba(158, 0, 93, 0.3)',
          '--button-hover-shadow': 'rgba(158, 0, 93, 0.4)',
          '--button-disabled': 'rgba(158, 0, 93, 0.3)',
          '--button-disabled-text': 'rgba(255, 255, 255, 0.7)',
          '--scrollbar-white': 'rgba(255, 255, 255, 0.2)',
          '--scrollbar-white-hover': 'rgba(255, 255, 255, 0.3)',
          '--text-shadow': 'rgba(0,0,0,0.3)',
          '--card-shadow': 'rgba(158, 0, 93, 0.3)',
          '--card-hover-shadow': 'rgba(158, 0, 93, 0.4)',
          '--info-bg': 'rgba(158, 0, 93, 0.04)',
          '--info-border': 'rgba(158, 0, 93, 0.06)',
          '--info-shadow': 'rgba(158, 0, 93, 0.04)',
          '--chip-bg': 'rgba(158, 0, 93, 0.1)',
          '--chip-border': 'rgba(158, 0, 93, 0.3)',
          '--upload-hover-border': 'rgba(158, 0, 93, 0.28)',
          '--upload-hover-shadow': 'rgba(158, 0, 93, 0.09)',
          '--success-confirmed': '#4CAF50',
          ...
          '--success-button-shadow': 'rgba(158, 0, 93, 0.28)',
          '--success-hover-shadow': 'rgba(158, 0, 93, 0.34)',
