        ...
        >
          <Paper
            ...
            sx={{
              ...
              '&:hover': {
                boxShadow: '0 30px 80px rgba(102, 45, 145, 0.20)',
          ...
          >
              ...
              sx={{
                ...
                '& .MuiOutlinedInput-root': {
                  ...
                  '&:hover': {
                    ...
                    '& fieldset': {
                      borderColor: 'rgba(102, 45, 145, 0.4)'
                    }
                  },
                  '&.Mui-focused': {
                    boxShadow: '0 4px 16px rgba(102, 45, 145, 0.15)',
                    '& fieldset': { 
            ...
            <Button
              ...
              sx={{ 
                ...
                '&:hover': {
                  background: 'linear-gradient(135deg,rgb(27, 20, 100), #662d91)',
        ...
        <Box sx={{ mt: 2, textAlign: 'center', opacity: 0.8 }}>
          <Typography 
            ...
            sx={{ 
              ...
              letterSpacing: '1px',
              fontWeight: 600,
              textShadow: '0 2px 4px rgba(102, 45, 145, 0.1)'
            }}
          >
